...
public abstract class Edrueliumarmor extends ArmorItem {
    public Edrueliumarmor(EquipmentSlot slot, Item.Properties properties) {
    ...
    public static class Helmet extends Edrueliumarmor {
        public Helmet() {
            super(EquipmentSlot.HEAD, new Item.Properties().tab(ModCreativeModeTab.ARMOR_TAB).fireResistant());
        }
    ...
    public static class Chestplate extends Edrueliumarmor {
        public Chestplate() {
            super(EquipmentSlot.CHEST, new Item.Properties().tab(ModCreativeModeTab.ARMOR_TAB).fireResistant());
        }
    ...
    public static class Leggings extends Edrueliumarmor {
        public Leggings() {
            super(EquipmentSlot.LEGS, new Item.Properties().tab(ModCreativeModeTab.ARMOR_TAB).fireResistant());
        }
    ...
    public static class Boots extends Edrueliumarmor {
        public Boots() {
            super(EquipmentSlot.FEET, new Item.Properties().tab(ModCreativeModeTab.ARMOR_TAB).fireResistant());
        }
